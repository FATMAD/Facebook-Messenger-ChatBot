...
var Message = function Message(body, recastToken) {
  ...
  this.reply = function () {
    ...
    _this._messageStack = [];
    return agent('POST', _constants2.default.MESSAGE_ENDPOINT.replace(':conversation_id', _this.conversationId)).set('Authorization', 'Token ' + _this.recastToken).send({ messages: messages }).catch(function (err) {
