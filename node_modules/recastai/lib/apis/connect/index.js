...
var Connect = function Connect(token) {
  ...
  this.sendMessage = function (messages, conversationId) {
    return agent('POST', _constants2.default.MESSAGE_ENDPOINT.replace(':conversation_id', conversationId)).set('Authorization', 'Token ' + _this.token).send({ messages: messages }).catch(function (err) {
